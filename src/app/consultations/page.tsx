          ...
          <div className="lg:w-[40%] md:w-[60%] w-[90%] mx-auto p-10 ">
            <div className="border-[6px] border-[#066B87] relative rounded-full  p-5 py-10">
              <div className="absolute size-full left-0 block -bottom-5 ">
                ...
                <p
                  className="text-[#066B87] font-bold text-[28px] xl:text-[40px] absolute lg:-bottom-20 -bottom-14 left-1/2 -translate-x-1/2 w-full text-center"
                  dir="rtl"
                >
                  5 مستشارين اعمال
                </p>
      ...
      <div className="section-1 my-5 py-5">
        <div className="w-[90%] mx-auto">
          <div className="cards my-10 flex flex-wrap justify-between gap-y-5">
            <div className="card rounded-xl shadow-lg shadow-black/50 p-4 flex flex-col gap-y-3 items-center justify-center lg:w-[22%] md:w-[45%] w-[60%] mx-auto">
              <div className="relative">
                <img src="/images/Person.png" alt="" className=" rounded-full" />
                <img
                  src="/images/true.png"
                  alt=""
              ...
              <a href="instructors/instructor-1.html" className="font-bold text-[30px]">
                هدى{" "}
              </a>

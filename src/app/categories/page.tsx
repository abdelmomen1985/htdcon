    ...
    <body>
      ...
      <div className="section-1 w-[90%] mx-auto lg:h-screen relative ">
        ...
        <img
          ...
          className="absolute lg:top-20 -top-10 right-60 w-[150px] h-[97px] hidden md:block"
          alt=""
        />
        <img
          src="/images/shape.png"
      ...
      <div className="section-2 w-[90%] mx-auto mt-20 ">
        <div className="flex justify-between gap-y-6 flex-row-reverse  w-full mx-auto flex-wrap items-center my-10">
          <div className=" card-1 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/1.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-16 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/101.png"
            ...
            <img
              src="/images/1.png"
              className="absolute bottom-10 left-1/2 -translate-x-1/2 h-[35%] w-[90%] z-20 object-cover rounded-2xl "
              alt=""
            />
          </div>
          <div className=" card-2 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/2.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/102.png"
                className="mx-auto size-24  object-contain"
                alt=""
          ...
          <div className=" card-3 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/3.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/103.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-4 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/4.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/104.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-5 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/5.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/105.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-6 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/6.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/106.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-7 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/7.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/107.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-8 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/8.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/108.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-9 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/9.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/109.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-10 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/10.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/110.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-11 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/11.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/111.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-12 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/12.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/112.png"
                className="mx-auto size-24  object-contain"
          ...
          <div className=" card-13 lg:w-[32%] md:w-[48%] w-full relative rounded-xl">
            <img src="/images/13.png" className="w-full rounded-xl" alt="" />
            <div className="mx-auto w-[90%] z-30 h-[30%] p-1 text-center absolute bottom-14 left-1/2 -translate-x-1/2 ">
              <img
                src="/images/113.png"
                className="mx-auto size-24  object-contain"
